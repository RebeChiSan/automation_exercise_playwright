      ...
      - generic [ref=f1e2]:
        - iframe [ref=f1e5]:
          - generic [ref=f2e1]:
            ...
            - paragraph [ref=f2e20] [cursor=pointer]:
              - generic [ref=f2e21] [cursor=pointer]: Seleccionar Plan
            - paragraph [ref=f2e25] [cursor=pointer]:
              - generic [ref=f2e26] [cursor=pointer]: Seleccionar Plan
            - generic [ref=f2e31]:
              - paragraph [ref=f2e33] [cursor=pointer]: Mensual
              - paragraph [ref=f2e35] [cursor=pointer]: Anual
